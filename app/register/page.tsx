                    ...
                    <div className="space-y-6">
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100">Quick signup process with email or phone verification</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                ...
                                <p className="text-blue-100">Complaints automatically routed to the right authorities</p>
                            </div>
                        </div>
