  ...
  return (
    <div className="min-h-screen bg-background py-8">
      <div className="container mx-auto px-4 max-w-4xl">
            ...
            filteredNotifications.map((notification, index) => {
              ...
              return (
                <motion.div
                  ...
                  className={`bg-card rounded-xl shadow-sm border border-border p-4 hover:shadow-md transition-shadow cursor-pointer ${
                  ...
                  onClick={() => {
                    ...
                    if (data.complaint_id) {
                      router.push(`/issues/${data.complaint_id}`);
                    }
                  }}
                >
                  <div className="flex items-start gap-4">
                    <div
                      className={`p-3 rounded-lg ${!notification.read ? "bg-primary/10" : "bg-muted"}`}
                    >
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground mb-2 text-pretty wrap-break-word">
                        ...
                        <div className="flex items-center gap-4 text-xs text-gray-500">
                          {data.complaint_id && (
                            <span className="font-mono">
                              ID: {data.complaint_id.substring(0, 8)}
                            </span>
                          )}
                          {data.status && (
        ...
        {filteredNotifications.length > 0 &&
          filteredNotifications.length % 20 === 0 && (
