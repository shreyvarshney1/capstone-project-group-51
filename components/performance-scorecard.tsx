    ...
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          ...
          {/* Resolution Rate */}
          <div
            className={`p-4 rounded-lg ${getScoreBg(resolutionRate, [80, 60])}`}
          >
            <div className="flex items-center justify-between mb-2">
              <CheckCircle
                className={`h-5 w-5 ${getScoreColor(resolutionRate, [80, 60])}`}
              />
            ...
            <div
              className={`text-2xl font-bold ${getScoreColor(resolutionRate, [80, 60])}`}
            >
              {resolutionRate}%
            </div>
          ...
          {/* Avg Resolution Time */}
          <div
            className={`p-4 rounded-lg ${getScoreBg(100 - (stats.averageResolutionTime / 168) * 100, [70, 40])}`}
          >
            <div className="flex items-center justify-between mb-2">
          ...
          {/* SLA Compliance */}
          <div
            className={`p-4 rounded-lg ${getScoreBg(stats.slaCompliance, [90, 70])}`}
          >
            <div className="flex items-center justify-between mb-2">
              <Target
                className={`h-5 w-5 ${getScoreColor(stats.slaCompliance, [90, 70])}`}
              />
            ...
            <div
              className={`text-2xl font-bold ${getScoreColor(stats.slaCompliance, [90, 70])}`}
            >
              {stats.slaCompliance}%
            </div>
