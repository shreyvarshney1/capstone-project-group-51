...
export function IssueForm() {
  ...
  const { draft, saveDraft, clearDraft, isOnline } =
    useOfflineDraft("issue-form");
  const { t } = useLanguage();
  ...
  const form = useForm<IssueFormValues>({
    ...
    defaultValues: draft
      ? {
          ...
          longitude: draft.longitude || 77.209,
          isPublic: true,
          language: "en",
        }
      : {
  ...
  async function onSubmit(data: IssueFormValues) {
    ...
    try {
      ...
      if (!isOnline) {
        ...
        alert(
          "You're offline. Your report has been saved and will be submitted when you're back online.",
        );
      } else {
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
        ...
        {!isOnline && (
          <div className="p-3 bg-amber-50 dark:bg-amber-900/20 border border-amber-200 dark:border-amber-800 rounded-lg text-sm">
            ...
            <p className="text-amber-700 dark:text-amber-300 text-xs mt-1">
              Your report will be saved locally and submitted when you&apos;re
              back online.
            </p>
          </div>
        )}
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                ...
                {voiceSupported && "Use the mic button for voice input."}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormDescription>
                ...
                {voiceSupported && "Click the mic icon for voice-to-text."}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <div className="rounded-lg border-2 p-4 bg-blue-50 dark:bg-blue-950/20">
          ...
          <p className="text-xs text-muted-foreground mt-2">
            💡 Use &quot;My Current Location&quot; for automatic GPS
            coordinates, or enter manually.
          </p>
        </div>
        ...
        <div className="rounded-lg border-2 p-4">
          ...
          <p className="text-xs text-muted-foreground">
            Add up to 5 photos to help describe the issue. Clear photos improve
            resolution time.
          </p>
        </div>
        ...
        <Button
          ...
          className="w-full h-11 bg-linear-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 shadow-lg hover:shadow-xl transition-all text-base font-semibold"
          size="lg"
        >
          {isSubmitting ? (
            <>
        ...
        {draft && (
          <div className="flex items-center justify-between text-sm text-muted-foreground">
            <span>
              Draft saved at {new Date(draft.savedAt).toLocaleTimeString()}
            </span>
            <Button
              type="button"
              variant="ghost"
